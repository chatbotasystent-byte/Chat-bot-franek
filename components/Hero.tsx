...
export function Hero() {
  return (
    <section className="relative px-5 pb-16 pt-16 sm:px-8 lg:px-12 lg:pb-24 lg:pt-20">
      ...
      <div className="absolute left-[-8rem] top-20 -z-10 h-80 w-80 rounded-full bg-cyan-400/16 blur-3xl" />
      <div className="absolute right-[-6rem] top-10 -z-10 h-96 w-96 rounded-full bg-violet-500/18 blur-3xl" />

      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_560px] lg:items-center">
        <div>
          <div className="inline-flex rounded-full border border-cyan-300/25 bg-white/[0.06] px-4 py-2 text-sm font-semibold text-cyan-200 shadow-[0_0_28px_rgba(34,211,238,0.16)] backdrop-blur">
            AI dla firm, które chcą działać szybciej
          </div>

          <h1 className="mt-7 max-w-5xl text-4xl font-semibold tracking-normal text-white sm:text-5xl lg:text-6xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#kontakt"
              className="rounded-full bg-gradient-to-r from-cyan-300 to-violet-400 px-6 py-3 text-sm font-semibold text-slate-950 shadow-[0_0_36px_rgba(34,211,238,0.32)] transition hover:scale-[1.02]"
            >
              Zamów darmowe demo
            </a>
            <a
