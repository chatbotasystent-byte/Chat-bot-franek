...
export function ChatModal({ suggestions, showIntro = true }: ChatModalProps) {
  ...
  return (
    <>
      {showIntro ? (
        <div className="dark-green-card gradient-border mx-auto max-w-4xl rounded-3xl p-6 text-center sm:p-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-7 text-[#9BB7AA]">
      ...
      >
        <div
          className="flex h-full min-h-0 w-full flex-col overflow-hidden rounded-3xl border border-[#34D399]/18 bg-gradient-to-br from-[#0B1F18] via-[#071B14] to-[#030705] shadow-2xl shadow-emerald-950/36"
        >
          <div className="flex flex-none items-start justify-between gap-3 border-b border-[#34D399]/14 bg-[#0B1F18]/80 px-4 py-3 sm:gap-4 sm:px-6 sm:py-4">
            <div>
              <h2 className="text-xl font-semibold text-white">
                Demo chatbota AI
              </h2>
              <p className="mt-1 line-clamp-2 text-xs leading-5 text-[#9BB7AA] sm:text-sm sm:leading-6">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-[#34D399]/18 bg-[#06110D]/80 text-lg font-semibold text-white transition hover:border-[#86EFAC]/40 hover:bg-[#0E2A24]"
          ...
          <div className="min-h-0 flex-1 overflow-hidden bg-[#06110D] p-3 sm:p-4">
