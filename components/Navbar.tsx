...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 border-b border-[#22C55E]/12 bg-[#050706]/86 px-5 py-4 shadow-[0_12px_40px_rgba(0,0,0,0.18)] backdrop-blur-2xl sm:px-8 lg:px-12">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-5">
        <a href="#" className="group flex items-center gap-3" aria-label="AI Automatyzacja - strona główna">
          ...
          <span className="grid gap-0.5">
            <span className="text-sm font-semibold text-[#F4FFF9] sm:text-base">AI Automatyzacja</span>
