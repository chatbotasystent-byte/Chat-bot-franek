...
export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-screen bg-[#171717] px-5 py-12 text-[#F7F2E8] sm:px-8 lg:px-12">
      <section className="mx-auto max-w-3xl rounded-3xl border border-[#E8D7B9]/16 bg-white/[0.045] p-6 shadow-[0_30px_100px_rgba(0,0,0,0.22)] backdrop-blur sm:p-8">
        <Link
          href="/"
          className="inline-flex rounded-full border border-[#E8D7B9]/22 px-4 py-2 text-sm font-semibold text-[#E8D7B9] transition hover:border-[#E8D7B9]/45 hover:bg-white/[0.06]"
        >
          Wróć na stronę główną
        </Link>

        <p className="mt-8 text-sm font-semibold uppercase tracking-[0.18em] text-[#E8D7B9]">
          AI Automatyzacja
        </p>
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-[#D6D3D1]">
          <section>
            <h2 className="text-lg font-semibold text-[#F7F2E8]">Jakie dane zbieramy?</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F7F2E8]">W jakim celu?</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F7F2E8]">Gdzie trafiają dane?</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F7F2E8]">Jak długo przechowujemy dane?</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F7F2E8]">Kontakt</h2>
            <p className="mt-2">
